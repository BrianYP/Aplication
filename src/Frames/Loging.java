...
public class Loging extends javax.swing.JFrame {
    //Instancias
    login lg = new login();//Instanciamos clase login y loginDAO
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Correo de Usuario");

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/usuario1.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //ACCION QUE HARA EL BOTON INICIO PARA INGRESAR A LA APP
        validar();//llamos metodo validar
